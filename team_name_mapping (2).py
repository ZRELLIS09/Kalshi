"""
Team Name Mapping: Odds API Ã¢â€ â€ Torvik
Generated: 364 teams, all verified.
"""
...
ODDS_TO_TORVIK = {
    ...
    "San JosÃƒÂ© St Spartans": "San Jose St.",
...
TORVIK_TO_ODDS = {v: k for k, v in ODDS_TO_TORVIK.items()}

def odds_to_torvik(name):
    """Convert Odds API team name to Torvik name."""
    return ODDS_TO_TORVIK.get(name.strip(), name.strip())

def torvik_to_odds(name):
    """Convert Torvik team name to Odds API name."""
    return TORVIK_TO_ODDS.get(name.strip(), name.strip())
